...
namespace RTUtil
{
  ...
  public:
    ...
    Camera(const Eigen::Vector3f &eye, const Eigen::Vector3f &target,
           const Eigen::Vector3f &vertical, float aspect, float near, float far) : m_eye(eye), m_target(target), m_vertical(vertical), m_aspect(aspect),
  ...
  public:
    ...
    PerspectiveCamera(const Eigen::Vector3f &eye, const Eigen::Vector3f &target,
                      ...
                      float fovy) : Camera(eye, target, vertical, aspect, near, far), fovy(fovy) {}
  ...
  public:
    ...
    OrthoCamera(const Eigen::Vector3f &eye, const Eigen::Vector3f &target,
                ...
                float far, float scale) : Camera(eye, target, vertical, aspect, near, far), scale(scale) {}
